export const SPREADSHEET_IDS: Record<string, Record<"ME" | "SIPIL", string>> = {
    ...
    "BANDUNG RAYA": { "ME": "13xo-gjJnXlCWXKNfW3ZugEYxK6qz1jvUq2ScSBJF1cw", "SIPIL": "11Weq3EIPCo-_bOPvTrSBQPcpXNPu5VTIoWHPA4ZJfHw" },
    ...
    "BINTAN": { "ME": "1pUf7XBVN-eR7ptaeCqjHIokeRyu2xrE-_Y4b0KK0Uz8", "SIPIL": "1sl-1CfcEerMzpU-Boc-p7ePSZWbj53kq4DXjrC145R4" },
    ...
    "SIDOARJO BPN SMD": { "ME": "1j1B7Yvgz5X02VcCuNSJC7btZv_tumFFmeMvxNEaS0ec", "SIPIL": "18BT0u4sHuNZA-NKxdcDeNTkxT35Mag4zOW9RjduRE8A" },
...
export const BRANCH_TO_ULOK_MAP: Record<string, string> = {
    ...
    "CIANJUR": "2JZ1", "BALARAJA": "TZ01", "SIDOARJO": "UZ01", "SIDOARJO BPN SMD": "UZ01",
...
export const ULOK_TO_BRANCH_MAP: Record<string, string> = Object.fromEntries(
    Object.entries(BRANCH_TO_ULOK_MAP).map(([branch, ulok]) => [ulok, branch])
);
